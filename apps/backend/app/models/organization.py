...
class OrganizationQuestionnaire(Base, TimestampMixin):
    __tablename__ = "organization_questionnaires"
    __table_args__ = (
        Index("ix_organization_questionnaires_organization_id", "organization_id"),
        Index("ix_organization_questionnaires_is_active", "is_active"),
    )
    ...
    title: Mapped[str] = mapped_column(String(255), default="Audio comparison questionnaire", nullable=False)
